...
* June 2020: our preprint ["Explicit Jacobian matrix formulas for entropy stable summation-by-parts schemes"](https://arxiv.org/abs/2006.07504) is now available on arXiv. We derive the structure of Jacobian matrices for entropy stable formulations based on flux differencing. Numerical examples show how these formulas can be applied to two-derivative and implicit time-stepping schemes. 
