...
* Jan 2018: our paper on [provably stable DG methods for elasticity with sub-cell heterogeneities](https://onlinelibrary.wiley.com/doi/abs/10.1002/nme.5720) is available online. This work extends the concept of the "weight-adjusted mass matrix" to matrix-valued weights, with applicability to elastic wave propagation. This approach factors out material coefficients into the mass matrix, resulting in a homogeneous and constant coefficient right hand side. This allows for the simple and unified construction of stable upwinded DG methods for general stiffness tensors (both isotropic and anisotropic). 
