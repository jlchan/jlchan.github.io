...
Below are selected recent talks, with select accompanying slides or video. A complete list of talks can be found on my [CV](../files/jcv.pdf).

* High order entropy stable schemes for the quasi-1D shallow water and compressible Euler equations (SIAM TX-LA, November 2023). [Slides](../files/SIAM_TXLA_2023.pdf)
* High order positivity-preserving entropy stable discontinuous Galerkin discretizations (Brown University, October 2023). [Slides](../files/Brown_2023.pdf)
* Constructing robust high order discontinuous Galerkin methods (November 2022, Ohio State). [Slides](../files/OhioState_2022.pdf)
